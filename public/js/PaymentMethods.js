...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateTotals() {
        ...
        quantityInputs.forEach((input, index) => {
            ...
            const price = parseFloat(priceCells[index].textContent.replace("£", "").replace(",", "")); // Get the price value
        ...
        basketTotal.textContent =  totalPrice.toLocaleString("en-GB", { minimumFractionDigits: 2 });
        ...
        if (totalItems === 0) {
            ...
            const monthly = ((totalPrice * (1 + interestRate)) / months).toFixed(2);
            ...
            disclaimer.innerHTML = `<strong>Illustrative example:</strong> Credit amount £${totalPrice.toFixed(2)}. Pay 36 monthly payments of £${monthly}. Total amount payable £${totalAmountPayable}. The interest rate for this purchase is 19.9%.<br><strong>Representative example:</strong> Rate of interest 19.9% (variable). 19.9% APR representative (variable). Assumed Credit Limit £1,200.`;
        }
    }
