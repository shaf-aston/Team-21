document.addEventListener("DOMContentLoaded", function () {
    ...
    const Responses = {
      ...
      "how are you": "I  am only what I am, I have no feelings but a for a bot with no bearing of emotions I am doing great",
      "bye": "Goodbye! Have a nice day!",
      "When is new stock arriving":"Our Stock is always dynamically changing as we like to keep with the trends, if there is something you want that is currently out of stock, Please send a message to the Stock Management team and they will update it as soon as possible",
      "I am unhappy with your services":"Sorry to have disappointed you,I sympathise with your frustration ",
