...
document.addEventListener('DOMContentLoaded', function() { 
    ...
    function updateTotals() { 
        ...
        if (totalItems === 0) { 
            ...
            const formattedDate = laterDate.toLocaleDateString('en-GB', { year: 'numeric', month: 'long', day: 'numeric' }); 
